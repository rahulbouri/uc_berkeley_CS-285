...
if __name__ == "__main__":
    print("We are downloading the dataset to the directory: data")
    download_pusht(Path("data"))
    print("We are loading the dataset from the directory: data")
    states, actions, episode_ends = load_pusht_zarr(Path("data") / ZARR_RELATIVE_PATH)
    print("We are building the normalizer")
    normalizer = Normalizer.from_data(states, actions)
    print("We are building the dataset")
    dataset = PushtChunkDataset(states, actions, episode_ends, 8, normalizer)
    print("We are printing the length of the dataset")
    print(len(dataset))
    print("We are printing the dataset's first element")
    print(dataset[0])
    print("Tensor shape ")